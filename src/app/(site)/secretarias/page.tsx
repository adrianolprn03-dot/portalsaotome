...
export const metadata: Metadata = {
    title: "Secretarias Municipais | Prefeitura de São Tomé",
    description: "Conheça as secretarias da Prefeitura de São Tomé e os serviços que cada uma oferece",
};
    ...
    return (
        <div className="min-h-screen bg-[#f8fafc]">
            <PageHeader
                ...
                subtitle="Gestão institucional e serviços dedicados à população de São Tomé."
                variant="premium"
