...
export default async function PortariasPage() {
    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] font-['Montserrat',sans-serif]">
            <PageHeader
                title="Portarias Municipais"
                subtitle="Consulta aos atos administrativos e portarias oficiais do Poder Executivo."
                variant="premium"
            ...
            <div className="pt-0">
                <LegislacaoClient initialTipo="portaria" hideTipoFilter={true} />
            </div>
